    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{URL::to('/submit-add-purchase-order')}}" method="POST" data-toggle="validator">
                        @csrf
                        <div class="row"> 
                            <div class="col-md-12">
                                <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="orderDate" type="text" name="orderDate" value="{{ now()->setTimezone('Asia/Ho_Chi_Minh') }}" class="form-control" placeholder="Thời gian tạo">
                                    </div>

                                    <div class="form-group">
                                        <label for="	totalPrice">Tổng tiền</label>
                                        <input id="	totalPrice" type="text" name="totalPrice"  class="form-control" placeholder="Tổng tiền">
                                    </div>

                                    <div class="form-group">
                                        <label for="createBy">Người tạo</label>
                                        <input id="	createBy" type="text" name="createBy"  class="form-control" value="{{ Session::get('AdminName') }}" readonly>
                                    </div>
